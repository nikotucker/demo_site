!function(e, t) {
    ...
    function o(i, c, s, l) {
        var a = c.$cont[0]
          , f = i[c.currSlide]
          , u = i[c.nextSlide];
        if (s && c.busy && c.manualTrump && (n("manualTrump in go(), stopping active transition"),
        e(i).stop(!0, !0),
        c.busy = 0,
        clearTimeout(a.cycleTimeout)),
        c.busy)
            n("transition active, ignoring new tx request");
        else if (a.cycleStop == c.stopCount && (0 !== a.cycleTimeout || s))
            if (s || a.cyclePause || c.bounce || !(c.autostop && --c.countdown <= 0 || c.nowrap && !c.random && c.nextSlide < c.currSlide)) {
                var d, h = !1;
                if (!s && a.cyclePause || c.nextSlide == c.currSlide)
                    y();
                else {
                    h = !0;
                    var p = c.fx;
                    ...
                    c.multiFx && (l && (c.lastFx === t || ++c.lastFx >= c.fxs.length) ? c.lastFx = 0 : !l && (c.lastFx === t || --c.lastFx < 0) && (c.lastFx = c.fxs.length - 1),
                    p = c.fxs[c.lastFx]),
                    c.oneTimeFx && (p = c.oneTimeFx,
                    c.oneTimeFx = null),
                    ...
                    c.busy = 1,
                    c.fxFn ? c.fxFn(f, u, c, m, l, s && c.fastOnEvent) : e.isFunction(e.fn.cycle[c.fx]) ? e.fn.cycle[c.fx](f, u, c, m, l, s && c.fastOnEvent) : e.fn.cycle.custom(f, u, c, m, l, s && c.fastOnEvent)
                }
                if (h || c.nextSlide == c.currSlide)
                    c.lastSlide = c.currSlide,
                    c.random ? (c.currSlide = c.nextSlide,
                    ++c.randomIndex == i.length && (c.randomIndex = 0,
                    c.randomMap.sort(function(e, t) {
                        return Math.random() - .5
                    })),
                    c.nextSlide = c.randomMap[c.randomIndex],
                    c.nextSlide == c.currSlide && (c.nextSlide = c.currSlide == c.slideCount - 1 ? 0 : c.currSlide + 1)) : c.backwards ? (d = c.nextSlide - 1 < 0) && c.bounce ? (c.backwards = !c.backwards,
                    c.nextSlide = 1,
                    c.currSlide = 0) : (c.nextSlide = d ? i.length - 1 : c.nextSlide - 1,
                    c.currSlide = d ? 0 : c.nextSlide + 1) : (d = c.nextSlide + 1 == i.length) && c.bounce ? (c.backwards = !c.backwards,
                    c.nextSlide = i.length - 2,
                    c.currSlide = i.length - 1) : (c.nextSlide = d ? 0 : c.nextSlide + 1,
                    c.currSlide = d ? i.length - 1 : c.nextSlide - 1);
        ...
        function y() {
            var e = 0;
            c.timeout;
            c.timeout && !c.continuous ? (e = r(i[c.currSlide], i[c.nextSlide], c, l),
            "shuffle" == c.fx && (e -= c.speedOut)) : c.continuous && a.cyclePause && (e = 10),
    ...
    function r(e, t, i, c) {
        if (i.timeoutFn) {
            for (var s = i.timeoutFn.call(e, e, t, i, c); "none" != i.fx && s - i.speed < 250; )
                s += i.speed;
            if (n("calculated timeout: " + s + "; speed: " + i.speed),
            !1 !== s)
                return s
        }
        return i.timeout
    ...
    function l(t, n) {
        ...
        t.random && i < 0)
            t.randomIndex--,
            -2 == --t.randomIndex ? t.randomIndex = c.length - 2 : -1 == t.randomIndex && (t.randomIndex = c.length - 1),
        ...
        return e.isFunction(l) && l(i > 0, t.nextSlide, c[t.nextSlide]),
        o(c, t, 1, n),
        !1
    }
    function a(t) {
    ...
    e.fn.cycle = function(f, u) {
        ...
        return 0 === this.length && "stop" != f ? !e.isReady && d.s ? (i("DOM not ready, queuing slideshow"),
        e(function() {
            e(d.s, d.c).cycle(f, u)
        }),
        ...
        this) : this.each(function() {
            var h = function(n, s, r) {
                ...
                s !== t && null !== s || (s = {});
                {
                    if (s.constructor == String) {
                        ...
                        case "prev":
                        case "next":
                            return (l = e(n).data("cycle.opts")) ? ("string" == typeof r && (l.oneTimeFx = r),
                            e.fn.cycle[s](l),
                    ...
                    if (s.constructor == Number) {
                        var a = s;
                        return (s = e(n).data("cycle.opts")) ? a < 0 || a >= s.elements.length ? (i("invalid slide index: " + a),
                        !1) : (s.nextSlide = a,
                        n.cycleTimeout && (clearTimeout(n.cycleTimeout),
                        n.cycleTimeout = 0),
                ...
                function f(t, n, c) {
                    if (!t && !0 === n) {
                        ...
                        if (!s)
                            ...
                            !1;
                        c.cycleTimeout && (clearTimeout(c.cycleTimeout),
                        c.cycleTimeout = 0),
            ...
            if (!1 !== h) {
                h.updateActivePagerLink = h.updateActivePagerLink || e.fn.cycle.updateActivePagerLink,
                ...
                var p = e(this)
                  ...
                  , y = m.get();
                if (y.length < 2)
                    i("terminating; too few slides: " + y.length);
                else {
                    var g = function(r, f, u, d, h) {
                        var p, m = e.extend({}, e.fn.cycle.defaults, d || {}, e.metadata ? r.metadata() : e.meta ? r.data() : {}), y = e.isFunction(r.data) ? r.data(m.metaAttr) : null;
                        y && (m = e.extend(m, y));
                        m.autostop && (m.countdown = m.autostopCount || u.length);
                        var g = r[0];
                        r.data("cycle.opts", m),
                        m.$cont = r,
                        m.stopCount = g.cycleStop,
                        m.elements = u,
                        m.before = m.before ? [m.before] : [],
                        m.after = m.after ? [m.after] : [],
                        !e.support.opacity && m.cleartype && m.after.push(function() {
                            s(this, m)
                        });
                        ...
                        x.original.cssBefore = e.extend({}, x.cssBefore),
                        x.original.cssAfter = e.extend({}, x.cssAfter),
                        x.original.animIn = e.extend({}, x.animIn),
                        x.original.animOut = e.extend({}, x.animOut),
                        e.each(x.before, function() {
                            x.original.before.push(this)
                        }),
                        e.each(x.after, function() {
                            x.original.after.push(this)
                        }),
                        e.support.opacity || !m.cleartype || m.cleartypeNoBg || a(f);
                        var x;
                        "static" == r.css("position") && r.css("position", "relative");
                        m.width && r.width(m.width);
                        m.height && "auto" != m.height && r.height(m.height);
                        m.startingSlide !== t ? (m.startingSlide = parseInt(m.startingSlide, 10),
                        m.startingSlide >= u.length || m.startSlide < 0 ? m.startingSlide = 0 : p = !0) : m.backwards ? m.startingSlide = u.length - 1 : m.startingSlide = 0;
                        if (m.random) {
                            m.randomMap = [];
                            ...
                            p)
                                for (var w = 0; w < u.length; w++)
                                    m.startingSlide == m.randomMap[w] && (m.randomIndex = w);
                            else
                                m.randomIndex = 1,
                                m.startingSlide = m.randomMap[1]
                        } else
                            m.startingSlide >= u.length && (m.startingSlide = 0);
                        ...
                        f.css({
                            ...
                            var n;
                            n = m.backwards ? S ? t <= S ? u.length + (t - S) : S - t : u.length - t : S ? t >= S ? u.length - (t - S) : S - t : u.length - t,
                            e(this).css("z-index", n)
                        }),
                        e(u[S]).css("opacity", 1).show(),
                        s(u[S], m),
                        m.fit && (m.aspect ? f.each(function() {
                            var t = e(this)
                              , n = !0 === m.aspect ? t.width() / t.height() : m.aspect;
                            m.width && t.width() != m.width && (t.width(m.width),
                            t.height(m.width / n)),
                            m.height && t.height() < m.height && (t.height(m.height),
                            t.width(m.height * n))
                        }) : (m.width && f.width(m.width),
                        m.height && "auto" != m.height && f.height(m.height)));
                        ...
                        if ((m.containerResize || m.containerResizeHeight) && r.innerHeight() < 1) {
                            for (var b = 0, B = 0, I = 0; I < u.length; I++) {
                                ...
                                k || (k = F.offsetHeight || F.height || O.attr("height")),
                                b = A > b ? A : b,
                                B = k > B ? k : B
                            }
                            m.containerResize && b > 0 && B > 0 && r.css({
                                width: b + "px",
                                height: B + "px"
                            }),
                        ...
                        if (!1 === function(t) {
                            ...
                            if (t.fx.indexOf(",") > 0) {
                                ...
                                c = 0; c < t.fxs.length; c++) {
                                    var r = t.fxs[c];
                                    (s = o[r]) && o.hasOwnProperty(r) && e.isFunction(s) || (i("discarding unknown transition: ", r),
                                    t.fxs.splice(c, 1),
                                    c--)
                                }
                                if (!t.fxs.length)
                                ...
                                t.fxs = [];
                                for (var l in o)
                                    o.hasOwnProperty(l) && (s = o[l],
                                    o.hasOwnProperty(l) && e.isFunction(s) && t.fxs.push(l))
                            }
                            ...
                            return !1;
                        var H = !1;
                        if (d.requeueAttempts = d.requeueAttempts || 0,
                        f.each(function() {
                            var t = e(this);
                            if (this.cycleH = m.fit && m.height ? m.height : t.height() || this.offsetHeight || this.height || t.attr("height") || 0,
                            this.cycleW = m.fit && m.width ? m.width : t.width() || this.offsetWidth || this.width || t.attr("width") || 0,
                            t.is("img") && 0 === this.cycleH && 0 === this.cycleW && !this.complete) {
                                if (h.s && m.requeueOnImageNotLoaded && ++d.requeueAttempts < 100)
                                    return i(d.requeueAttempts, " - img slide not loaded, requeuing slideshow: ", this.src, this.cycleW, this.cycleH),
                                    setTimeout(function() {
                                        e(h.s, h.c).cycle(d)
                                    }, m.requeueTimeout),
                                    H = !0,
                        ...
                        H)
                            return !1;
                        if (m.cssBefore = m.cssBefore || {},
                        m.cssAfter = m.cssAfter || {},
                        m.cssFirst = m.cssFirst || {},
                        m.animIn = m.animIn || {},
                        m.animOut = m.animOut || {},
                        f.not(":eq(" + S + ")").css(m.cssBefore),
                        e(f[S]).css(m.cssFirst),
                        m.timeout) {
                            m.timeout = parseInt(m.timeout, 10),
                            m.speed.constructor == String && (m.speed = e.fx.speeds[m.speed] || parseInt(m.speed, 10)),
                            m.sync || (m.speed = m.speed / 2);
                            for (var R = "none" == m.fx ? 0 : "shuffle" == m.fx ? 500 : 250; m.timeout - m.speed < R; )
                                m.timeout += m.speed
                        }
                        m.easing && (m.easeIn = m.easeOut = m.easing);
                        m.speedIn || (m.speedIn = m.speed);
                        m.speedOut || (m.speedOut = m.speed);
                        m.slideCount = u.length,
                        m.currSlide = m.lastSlide = S,
                        m.random ? (++m.randomIndex == u.length && (m.randomIndex = 0),
                        m.nextSlide = m.randomMap[m.randomIndex]) : m.backwards ? m.nextSlide = 0 === m.startingSlide ? u.length - 1 : m.startingSlide - 1 : m.nextSlide = m.startingSlide >= u.length - 1 ? 0 : m.startingSlide + 1;
                        if (!m.multiFx) {
                            var P = e.fn.cycle.transitions[m.fx];
                            if (e.isFunction(P))
                                P(r, f, m);
                            else if ("custom" != m.fx && !m.multiFx)
                                return i("unknown transition: " + m.fx, "; slideshow terminating"),
                                !1
                        }
                        var W = f[S];
                        m.skipInitializationCallbacks || (m.before.length && m.before[0].apply(W, [W, W, m, !0]),
                        m.after.length && m.after[0].apply(W, [W, W, m, !0]));
                        ...
                        (m.pager || m.pagerAnchorBuilder) && (C = u,
                        z = m,
                        E = e(z.pager),
                        e.each(C, function(t, n) {
                            e.fn.cycle.createPagerAnchor(t, n, E, C, z)
                        }),
                        z.updateActivePagerLink(z.pager, z.startingSlide, z.activePagerClass));
                        var C, z, E;
                        return M = m,
                        N = u,
                        M.addSlide = function(t, n) {
                            var i = e(t)
                              , c = i[0];
                            M.autostopCount || M.countdown++,
                            N[n ? "unshift" : "push"](c),
                            M.els && M.els[n ? "unshift" : "push"](c),
                            M.slideCount = N.length,
                            M.random && (M.randomMap.push(M.slideCount - 1),
                            M.randomMap.sort(function(e, t) {
                                return Math.random() - .5
                            })),
                            i.css("position", "absolute"),
                            i[n ? "prependTo" : "appendTo"](M.$cont),
                            n && (M.currSlide++,
                            M.nextSlide++),
                            e.support.opacity || !M.cleartype || M.cleartypeNoBg || a(i),
                            M.fit && M.width && i.width(M.width),
                            M.fit && M.height && "auto" != M.height && i.height(M.height),
                            c.cycleH = M.fit && M.height ? M.height : i.height(),
                            c.cycleW = M.fit && M.width ? M.width : i.width(),
                            i.css(M.cssBefore),
                            (M.pager || M.pagerAnchorBuilder) && e.fn.cycle.createPagerAnchor(N.length - 1, c, e(M.pager), N, M),
                            e.isFunction(M.onAddSlide) ? M.onAddSlide(i) : i.hide()
                        }
                        ,
                        m;
                        var M, N
    ...
    e.fn.cycle.createPagerAnchor = function(t, i, s, r, l) {
        var a;
        if (e.isFunction(l.pagerAnchorBuilder) ? (a = l.pagerAnchorBuilder(t, i),
        n("pagerAnchorBuilder(" + t + ", el) returned: " + a)) : a = '<a href="#">' + (t + 1) + "</a>",
        a) {
            var f = e(a);
            ...
            /mouseenter|mouseover/i.test(l.pagerEvent) ? f.hover(d, function() {}) : f.bind(l.pagerEvent, d),
            /^click/.test(l.pagerEvent) || l.allowPagerClickBubble || f.bind("click.cycle", function() {
                return !1
            });
            var h = l.$cont[0]
              , p = !1;
    ...
    e.fn.cycle.commonReset = function(t, n, i, c, s, o) {
        ...
        i.slideResize && !1 !== c && n.cycleW > 0 && (i.cssBefore.width = n.cycleW),
        i.slideResize && !1 !== s && n.cycleH > 0 && (i.cssBefore.height = n.cycleH),
...
function(e) {
    ...
    e.fn.cycle.transitions.cover = function(t, n, i) {
        ...
        i.before.push(function(t, n, i) {
            e.fn.cycle.commonReset(t, n, i),
            i.cssAfter.display = "",
            "right" == c ? i.cssBefore.left = -s : "up" == c ? i.cssBefore.top = o : "down" == c ? i.cssBefore.top = -o : i.cssBefore.left = s
        }),
        i.animIn.left = 0,
        i.animIn.top = 0,
        i.cssBefore.top = 0,
    ...
    e.fn.cycle.transitions.uncover = function(t, n, i) {
        ...
        i.before.push(function(t, n, i) {
            e.fn.cycle.commonReset(t, n, i, !0, !0, !0),
            "right" == c ? i.animOut.left = s : "up" == c ? i.animOut.top = -o : "down" == c ? i.animOut.top = o : i.animOut.left = -s
        }),
        i.animIn.left = 0,
        i.animIn.top = 0,
        i.cssBefore.top = 0,
    ...
    e.fn.cycle.transitions.wipe = function(t, n, i) {
        var c, s = t.css("overflow", "hidden").width(), o = t.height();
        if (i.cssBefore = i.cssBefore || {},
        i.clip)
            if (/l2r/.test(i.clip))
                c = "rect(0px 0px " + o + "px 0px)";
            else if (/r2l/.test(i.clip))
                c = "rect(0px " + s + "px " + o + "px " + s + "px)";
            else if (/t2b/.test(i.clip))
                c = "rect(0px " + s + "px 0px 0px)";
